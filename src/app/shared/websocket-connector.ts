...
export class WebSocketConnector {
    ...
    constructor(private ip: string, private port: string, private topic: string, private onMessage: Function, private callbackError?: Function) {
    ...
    private connect(errorCallback: Function) {
        ...
        this.stompClient = Stomp.overTCP(this.ip, this.port);
